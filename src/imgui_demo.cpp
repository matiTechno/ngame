...
// their code base:
// Do NOT remove this file from your project! It is useful reference code that
// you and other users will want to refer to.
...
// learn about various features of ImGui.
// Removing this file from your project is hindering your access to
// documentation, likely leading you to poorer usage of the library.
    ...
    for (int i = 0; i < atlas->Fonts.Size; i++) {
      ...
      if (ImGui::TreeNode("Details")) {
        ...
        ShowHelpMarker("Note than the default embedded font is NOT meant to be "
                       "scaled.\n\nFont are currently rendered into bitmaps at "
                       "a given size at the time of building the atlas. You "
                       "may oversample them to get some flexibility with "
                       "scaling. You can also render at multiple sizes and "
                       "select which one to use at runtime.\n\n(Glimmer of "
                       "hope: the atlas system should hopefully be rewritten "
                       "in the future to make scaling more natural and "
                       "automatic.)");
        ...
        if (ImGui::TreeNode("Glyphs", "Glyphs (%d)", font->Glyphs.Size)) {
          ...
          const ImFont::Glyph *glyph_fallback =
              font->FallbackGlyph; // Forcefully/dodgily make FindGlyph() return
                                   // NULL on fallback, which isn't the default
                                   // behavior.
